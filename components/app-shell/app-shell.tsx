...
export function AppShell({
  ...
  return (
    <main className="app-viewport bg-[#04060a] text-[#eef2f8]">
      <div className="app-viewport mx-auto flex w-full max-w-[430px] flex-col bg-[#06080c] shadow-2xl md:my-8 md:min-h-[844px] md:overflow-hidden md:rounded-[42px] md:border md:border-white/10">
