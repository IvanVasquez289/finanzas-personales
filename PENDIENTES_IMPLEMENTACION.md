...
1. Registro de pagos de tarjeta y cierre de ciclo.
   - Estado: primera versión de registro de pago implementada.
   - Pendiente: cierre formal de ciclo, histórico y pagos parciales editables.
2. Registro de gasto completo.
   - Maquetado y primera server action implementada.
   - Pendiente: fecha/hora editable, React Hook Form, MSI como `InstallmentPlan`, mejor confirmación visual y duplicados tolerantes.
3. Distribución de quincena completa.
   - Maquetada y primera server action implementada.
   - Pendiente: capturar nuevo ingreso desde la pantalla, fecha de recepción, plantillas editables y React Hook Form.
4. Saldos confiables de sobres/cuentas.
   - Maquetado.
   - Pendiente: derivar saldos completamente desde allocations, gastos, pagos y ajustes auditables.
5. Dashboard con cálculos de dominio.
   - Maquetado y alimentado desde Prisma.
   - Pendiente: dinero libre, dinero comprometido, próximos pagos, alertas y filtros calculados con servicios puros.
...
4. Revisar permisos de runtime y migraciones.
5. Pruebas unitarias para servicios de dominio.
6. Pruebas de integración para server actions críticas.
...
- Calcular timeline de ciclo con fechas reales.
